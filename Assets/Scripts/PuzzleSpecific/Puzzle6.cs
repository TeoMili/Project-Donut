...
public class Puzzle6 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (piece1.transform.parent.gameObject.GetComponent<Image>() != place1 || piece2.transform.parent.gameObject.GetComponent<Image>() != place2 || piece3.transform.parent.gameObject.GetComponent<Image>() != place3)
        {
